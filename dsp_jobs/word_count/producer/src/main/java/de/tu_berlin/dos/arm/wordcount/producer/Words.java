...
public class Words {
    ...
    static final Logger LOG = Logger.getLogger(Words.class);
    ...
    public static class AdActor extends AbstractActor {
        ...
        public AdActor(int number, String topic, KafkaProducer<String, String> kafkaProducer) {
            this.topic = topic;
            ...
            return receiveBuilder()
                .match(Emit.class, e -> {
                    ...
                    if (this.number <= e.eventsCount) {
                        ...
                        String line = WORDS[rand.nextInt(WORDS.length)];
                        this.kafkaProducer.send(new ProducerRecord<>(
                                this.topic, null, line, line));
                    }
                })
